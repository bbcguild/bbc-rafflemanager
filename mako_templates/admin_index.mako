...
#main_table{
  width:100%;
  display:grid;
  grid-template-columns:minmax(0,1fr) minmax(408px, 452px);
  gap:12px;
  align-items:start;
...
@media (max-width:1450px){
  #main_table{
    grid-template-columns:minmax(0,1fr) minmax(396px, 436px);
  }
}
